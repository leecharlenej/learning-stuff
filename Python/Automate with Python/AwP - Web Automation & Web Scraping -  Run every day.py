...
# df_headlines.to_csv(f'{application_path}\headlines-{month_day_year}.csv')

file_name = f'headlines-{month_day_year}.csv'
final_path = os.path.join('C:\\Users\\leech\\Downloads\\00. School\\Personal\\learning-stuff\Python', file_name) # To ensure correct slashes are correct.
